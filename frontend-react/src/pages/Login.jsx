    ...
    <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh', padding: '20px' }}>
      <div className="glass-panel p-5 animate-fade-in" style={{ width: '100%', maxWidth: '440px' }}>
        <div className="text-center mb-4">
          ...
          <h2 className="text-gradient-purple mb-1">Welcome Back</h2>
          <p className="text-secondary small">Sign in to monitor and predict your stress levels</p>
        </div>
        ...
        <div className="text-center mt-3">
          <p className="text-secondary small mb-0">
            ...
            <Link to="/register" className="fw-bold text-decoration-none" style={{ color: 'var(--accent-purple)' }}>
              Sign Up
            </Link>
          </p>
        </div>
